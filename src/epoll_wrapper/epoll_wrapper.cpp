...
she_net::epoll_wrapper::epoll_wrapper() : epoll_wrapper(1024){};

she_net::epoll_wrapper::epoll_wrapper(int events_num)
    : user_events_(events_num), timeout_set_(-1), server_socket_fd_(-1) {
...
void she_net::epoll_wrapper::remove_alive_fd(int fd) {
  ...
  int control_result = ::epoll_ctl(epoll_container_id_, EPOLL_CTL_DEL, server_socket_fd_, &event_options);
...
std::vector<int> she_net::epoll_wrapper::accept_alive() {
